...
public class SeleniumFunctions extends TestRunner {
    ...
    static WebDriverWait w = new WebDriverWait(driver,EXPLICIT_TIMEOUT);;
    ...
    //--------- Page Path -------//
    public static String FileName = "orange_hrm.json";
    public static String PagesFilePath = "src/test/resources/locator_pages/";
    ...
    public boolean isElementDisPresentSize(String element) throws Exception {

        try {
            By SeleniumElement = SeleniumFunctions.getCompleteElement(element);
            log.info(String.format("Waiting Element for size: %s", element));
            isDisplayed = driver.findElements(SeleniumElement).size() > 0;
        }catch (NoSuchElementException | TimeoutException e){
            isDisplayed = false;
            log.info(e);
        }
    ...
    public void waitForElementClikable(String element) throws Exception
    {
        By SeleniumElement = SeleniumFunctions.getCompleteElement(element);
